    ...
    async setControlByAdapter(value) {
        try {
            ...
            if (this.loginData) {
                ...
                const configuredMaxPower = typeof this.config.ControlMaxPowerOutput === 'number' ? this.config.ControlMaxPowerOutput : 1200;
                ...
                const jsonstring = '{"mode_type":3,"custom_rate_plan":[{"index":0,"week":[0,1,2,3,4,5,6],"ranges":[{"start_time":"00:00","end_time":"24:00","power":400}]}],"blend_plan":null,"default_home_load":200,"max_load":1200,"min_load":0,"step":10}';
